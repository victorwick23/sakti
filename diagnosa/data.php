...
if(isset($_SESSION['admin']) || isset($_SESSION['dokter']) || isset($_SESSION['apoteker'])) { ?>
    ...
    <div class="box">
        <h1>Diagnosa</h1>
        <h4>
            <small>Data Diagnosa</small>
            <div class="pull-right">
                <a href="" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-refresh"></i></a>
                <a href="add.php" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-plus"></i> Tambah Diagnosa</a>
            </div>
        </h4>
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover table-condensed" id="diagnosa">
                <thead>
                    <tr class="info">
                ...
                <tbody>
                    ...
                    $query = "SELECT
                                ...
                                INNER JOIN tb_dokter ON tb_diagnosa.id_dokter = tb_dokter.id_dokter
                    ...
                    while ($data = mysqli_fetch_array($sql_diag)) { ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a href="add_qty.php?id=<?=$data['id_diagnosa']?>" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-plus"></i></a>
                                    <a href="add_satuan.php?id=<?=$data['id_diagnosa']?>"  class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-plus"></i></a>
                                </center>
                            </td>
                        </tr>
                    <?php
